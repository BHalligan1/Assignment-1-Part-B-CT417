...
public class Test {
    ...
    public static void main(String[] args) {
        ...
        Student student1 = new Student("Brendan Halligan", 20, 19419576);
        Student student2 = new Student("Joe Bloggs", 19, 12345678);
        Student student3 = new Student("Mary Smith", 21, 98765432);
        ...
        Lecturer lecturer1 = new Lecturer("Rachel King", 50, 67917002);
        Lecturer lecturer2 = new Lecturer("Jack Monaghan", 49, 26926812);
        Lecturer lecturer3 = new Lecturer("Liam Fahy", 51, 97572913);
        ...
        Module module2 = new Module("Mobile Networks", "EE4101");
        Module module3 = new Module("Embedded Systems","EE347");
        ...
        CourseProgramme courseProgramme1 = new CourseProgramme("BP4", new ArrayList<>(),new ArrayList<>(), DateTime.parse("2022-09-05"), DateTime.parse("2023-04-30"));
        CourseProgramme courseProgramme2 = new CourseProgramme("CS4", new ArrayList<>(), new ArrayList<>(), DateTime.parse("2022-09-05"), DateTime.parse("2023-04-30"));
        CourseProgramme courseProgramme3 = new CourseProgramme("DA4", new ArrayList<>(), new ArrayList<>(), DateTime.parse("2022-09-05"), DateTime.parse("2023-04-30"));
